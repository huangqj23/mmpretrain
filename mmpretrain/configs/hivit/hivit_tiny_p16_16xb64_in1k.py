# Converted from configs/hivit/hivit-tiny-p16_16xb64_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.hivit.tiny_224 import *  # noqa: F401,F403
