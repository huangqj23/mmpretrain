# Converted from configs/convnext/convnext-small_32xb128_in1k-384px.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.convnext.convnext_small import *  # noqa: F401,F403
