# Converted from configs/efficientnet_v2/efficientnetv2-b3_8xb32_in1k.py by industrial-vision tools/convert_configs.py
...
# model setting
model.merge(dict(backbone=dict(arch='b3'), head=dict(in_channels=1536, )))
