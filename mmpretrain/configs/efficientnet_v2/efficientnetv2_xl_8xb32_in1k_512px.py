# Converted from configs/efficientnet_v2/efficientnetv2-xl_8xb32_in1k-512px.py by industrial-vision tools/convert_configs.py
...
# model setting
model.merge(dict(backbone=dict(arch='xl'), ))
