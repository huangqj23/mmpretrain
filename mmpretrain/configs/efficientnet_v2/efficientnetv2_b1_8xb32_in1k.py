# Converted from configs/efficientnet_v2/efficientnetv2-b1_8xb32_in1k.py by industrial-vision tools/convert_configs.py
...
# model setting
model.merge(dict(backbone=dict(arch='b1'), head=dict(in_channels=1280, )))
