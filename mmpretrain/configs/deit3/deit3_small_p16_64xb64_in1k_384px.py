# Converted from configs/deit3/deit3-small-p16_64xb64_in1k-384px.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.deit3.deit3_small_p16_384 import *  # noqa: F401,F403
