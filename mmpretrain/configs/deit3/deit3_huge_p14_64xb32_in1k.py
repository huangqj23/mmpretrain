# Converted from configs/deit3/deit3-huge-p14_64xb32_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.deit3.deit3_huge_p14_224 import *  # noqa: F401,F403
