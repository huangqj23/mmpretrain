# Converted from configs/_base_/datasets/pipelines/auto_aug.py by industrial-vision tools/convert_configs.py
from mmpretrain.datasets import (AutoContrast, ColorTransform, Contrast,
                                 Equalize, Invert, Posterize, Rotate,
                                 Sharpness, Shear, Solarize)
