# Converted from configs/twins/twins-pcpvt-base_8xb128_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.twins_pcpvt_base import *  # noqa: F401,F403
