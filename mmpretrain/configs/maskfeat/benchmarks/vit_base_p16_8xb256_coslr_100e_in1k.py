# Converted from configs/maskfeat/benchmarks/vit-base-p16_8xb256-coslr-100e_in1k.py by industrial-vision tools/convert_configs.py
...
val_dataloader.merge(dict(batch_size=256, dataset=dict(pipeline=test_pipeline)))
