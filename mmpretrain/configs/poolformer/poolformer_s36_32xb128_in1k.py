# Converted from configs/poolformer/poolformer-s36_32xb128_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.poolformer.poolformer_s36 import *  # noqa: F401,F403
