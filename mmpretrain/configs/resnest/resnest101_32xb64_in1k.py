# Converted from configs/resnest/resnest101_32xb64_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.resnest101 import *  # noqa: F401,F403
