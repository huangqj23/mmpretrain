# Converted from configs/cspnet/cspresnet50_8xb32_in1k.py by industrial-vision tools/convert_configs.py
...
from mmpretrain.models import (CrossEntropyLoss, CSPResNet,
