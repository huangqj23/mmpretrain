# Converted from configs/mlp_mixer/mlp-mixer-large-p16_64xb64_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.mlp_mixer_large_patch16 import *  # noqa: F401,F403
