# Converted from configs/cae/benchmarks/beit-base-p16_8xb128-coslr-100e_in1k.py by industrial-vision tools/convert_configs.py
...
val_dataloader.merge(dict(dataset=dict(pipeline=test_pipeline), batch_size=128))
