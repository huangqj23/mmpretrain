# Converted from configs/t2t_vit/t2t-vit-t-14_8xb64_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.t2t_vit_t_14 import *  # noqa: F401,F403
