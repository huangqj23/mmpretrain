# Converted from configs/edgenext/edgenext-base_8xb256-usi_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base
from copy import deepcopy as __deepcopy

with read_base():
    from .edgenext_base_8xb256_in1k import *  # noqa: F401,F403
