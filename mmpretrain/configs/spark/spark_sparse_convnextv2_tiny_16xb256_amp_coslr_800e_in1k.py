# Converted from configs/spark/spark_sparse-convnextv2-tiny_16xb256-amp-coslr-800e_in1k.py by industrial-vision tools/convert_configs.py
...
from mmpretrain.models import (PixelReconstructionLoss, SparK,
                               ...
                               SparseConvNeXt, SparseLayerNorm2D)

# dataset 16 x 256
train_dataloader.merge(dict(batch_size=256, num_workers=8))
...
model = dict(
    ...
    downsample_raito=32,
    mask_ratio=0.6,
    enc_dec_norm_cfg=dict(type=SparseLayerNorm2D, eps=1e-6),
