# Converted from configs/van/van-large_8xb128_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.van.van_large import *  # noqa: F401,F403
