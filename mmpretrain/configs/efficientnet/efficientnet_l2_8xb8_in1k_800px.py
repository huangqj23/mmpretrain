# Converted from configs/efficientnet/efficientnet-l2_8xb8_in1k-800px.py by industrial-vision tools/convert_configs.py
...
train_dataloader.merge(dict(batch_size=8, dataset=dict(pipeline=train_pipeline)))
