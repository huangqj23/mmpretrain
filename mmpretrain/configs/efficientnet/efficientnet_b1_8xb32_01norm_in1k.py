# Converted from configs/efficientnet/efficientnet-b1_8xb32-01norm_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.efficientnet_b1 import *  # noqa: F401,F403
