# Converted from configs/vision_transformer/vit-large-p16_64xb64_in1k-384px.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.vit_large_p16 import *  # noqa: F401,F403
