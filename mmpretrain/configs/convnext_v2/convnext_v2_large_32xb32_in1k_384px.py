# Converted from configs/convnext_v2/convnext-v2-large_32xb32_in1k-384px.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.convnext_v2.large import *  # noqa: F401,F403
