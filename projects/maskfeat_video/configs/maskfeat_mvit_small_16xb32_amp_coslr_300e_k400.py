# Converted from projects/maskfeat_video/configs/maskfeat_mvit-small_16xb32-amp-coslr-300e_k400.py by industrial-vision tools/convert_configs.py
...
from mmpretrain.models import (LinearNeck, PixelReconstructionLoss,
