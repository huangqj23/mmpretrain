...
```shell
python tools/train.py configs/milan/milan_vit_base_p16_16xb256_amp_coslr_400e_in1k.py
```

Test:

```shell
python tools/test.py configs/milan/benchmarks/vit_base_p16_8xb128_coslr_100e_in1k.py https://download.openmmlab.com/mmselfsup/1.x/milan/milan_vit-base-p16_16xb256-amp-coslr-400e_in1k/vit-base-p16_ft-8xb128-coslr-100e_in1k/vit-base-p16_ft-8xb128-coslr-100e_in1k-milan_20221129-74ac94fa.pth
```
