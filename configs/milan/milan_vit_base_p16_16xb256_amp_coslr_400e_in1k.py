# Converted from configs/milan/milan_vit-base-p16_16xb256-amp-coslr-400e_in1k.py by industrial-vision tools/convert_configs.py
...
from mmpretrain.models import (MILAN, CLIPGenerator, CosineSimilarityLoss,
                               MILANPretrainDecoder, MILANViT, MIMHead)
