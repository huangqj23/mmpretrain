# Converted from configs/davit/davit-small_4xb256_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.davit.davit_small import *  # noqa: F401,F403
