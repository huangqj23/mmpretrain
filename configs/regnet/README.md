...
```shell
python tools/train.py configs/regnet/regnetx_400mf_8xb128_in1k.py
```

Test:

```shell
python tools/test.py configs/regnet/regnetx_400mf_8xb128_in1k.py https://download.openmmlab.com/mmclassification/v0/regnet/regnetx-400mf_8xb128_in1k_20211213-89bfc226.pth
```
