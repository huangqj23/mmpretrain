# Converted from configs/regnet/regnetx-400mf_8xb128_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.regnet.regnetx_400mf import *  # noqa: F401,F403
...
val_dataloader.merge(dict(batch_size=128))
test_dataloader.merge(dict(batch_size=128))

# schedule settings

# sgd with nesterov, base ls is 0.8 for batch_size 1024,
optim_wrapper.merge(dict(optimizer=dict(lr=0.8, nesterov=True)))
