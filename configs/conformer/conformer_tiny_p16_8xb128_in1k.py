# Converted from configs/conformer/conformer-tiny-p16_8xb128_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.conformer.tiny_p16 import *  # noqa: F401,F403
