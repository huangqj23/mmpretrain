# Converted from configs/conformer/conformer-small-p32_8xb128_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.conformer.small_p32 import *  # noqa: F401,F403
