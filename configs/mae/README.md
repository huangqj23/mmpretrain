...
```shell
python tools/train.py configs/mae/mae_vit_base_p16_8xb512_amp_coslr_300e_in1k.py
```

Test:

```shell
python tools/test.py configs/mae/benchmarks/vit_base_p16_8xb128_coslr_100e_in1k.py None
```
