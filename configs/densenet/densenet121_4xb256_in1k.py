# Converted from configs/densenet/densenet121_4xb256_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.densenet.densenet121 import *  # noqa: F401,F403
