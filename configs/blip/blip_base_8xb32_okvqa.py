# Converted from configs/blip/blip-base_8xb32_okvqa.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.datasets.coco_okvqa import *  # noqa: F401,F403
