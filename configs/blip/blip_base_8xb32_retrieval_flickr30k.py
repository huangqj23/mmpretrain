# Converted from configs/blip/blip-base_8xb32_retrieval_flickr30k.py by industrial-vision tools/convert_configs.py
...
default_hooks.merge(dict(logger=dict(interval=1)))
