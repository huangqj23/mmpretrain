# Converted from configs/hrnet/hrnet-w48_4xb32_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.hrnet.hrnet_w48 import *  # noqa: F401,F403
