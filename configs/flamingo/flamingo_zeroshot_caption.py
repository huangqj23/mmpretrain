# Converted from configs/flamingo/flamingo_zeroshot_caption.py by industrial-vision tools/convert_configs.py
...
from mmpretrain.datasets import FlamingoEvalCOCOCaption, PackInputs, ResizeEdge
from mmpretrain.evaluation import COCOCaption
from mmpretrain.models import (Flamingo, FlamingoLMAdapter,
