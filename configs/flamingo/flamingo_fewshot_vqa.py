# Converted from configs/flamingo/flamingo_fewshot_vqa.py by industrial-vision tools/convert_configs.py
...
from mmpretrain.datasets import (ApplyToList, FlamingoEvalCOCOVQA, PackInputs,
                                 ResizeEdge)
