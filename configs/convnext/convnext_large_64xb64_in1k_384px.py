# Converted from configs/convnext/convnext-large_64xb64_in1k-384px.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.convnext.convnext_large import *  # noqa: F401,F403
