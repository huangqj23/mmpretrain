# Converted from configs/swin_transformer_v2/swinv2-base-w12_8xb128_in21k-192px.py by industrial-vision tools/convert_configs.py
...
train_pipeline[1]['scale'] = 192  # RandomResizedCrop
test_pipeline[1]['scale'] = 219  # ResizeEdge
test_pipeline[2]['crop_size'] = 192  # CenterCrop
