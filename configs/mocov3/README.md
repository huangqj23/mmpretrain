...
```shell
python tools/train.py configs/mocov3/mocov3_resnet50_8xb512_amp_coslr_100e_in1k.py
```

Test:

```shell
python tools/test.py configs/mocov3/benchmarks/resnet50_8xb128_linear_coslr_90e_in1k.py https://download.openmmlab.com/mmselfsup/1.x/mocov3/mocov3_resnet50_8xb512-amp-coslr-100e_in1k/resnet50_linear-8xb128-coslr-90e_in1k/resnet50_linear-8xb128-coslr-90e_in1k_20220927-8f7d937e.pth
```
