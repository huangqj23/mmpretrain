# Converted from configs/levit/levit-192_8xb256_in1k.py by industrial-vision tools/convert_configs.py
...
# model settings
model.merge(dict(backbone=dict(arch='192'), head=dict(in_channels=384)))
