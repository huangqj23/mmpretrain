# Converted from configs/levit/levit-128s_8xb256_in1k.py by industrial-vision tools/convert_configs.py
...
# model settings
model.merge(dict(backbone=dict(arch='128s'), head=dict(in_channels=384)))
