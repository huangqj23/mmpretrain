# Converted from configs/maskfeat/maskfeat_vit-base-p16_8xb256-amp-coslr-300e_in1k.py by industrial-vision tools/convert_configs.py
...
from mmpretrain.datasets import (BEiTMaskGenerator, ImageNet, PackInputs,
                                 RandomResizedCrop)
from mmpretrain.models import (HOGGenerator, LinearNeck, MaskFeat, MaskFeatViT,
                               MIMHead, PixelReconstructionLoss,
...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=108,
        norm_cfg=None,
        init_cfg=dict(type=TruncNormalInit, layer='Linear', std=0.02, bias=0)),
    head=dict(
        type=MIMHead,
