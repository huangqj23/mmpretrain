# Converted from configs/hornet/hornet-tiny-gf_8xb128_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.hornet.hornet_tiny_gf import *  # noqa: F401,F403
