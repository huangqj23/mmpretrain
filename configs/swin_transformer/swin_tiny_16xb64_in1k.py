# Converted from configs/swin_transformer/swin-tiny_16xb64_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.swin_transformer.tiny_224 import *  # noqa: F401,F403
