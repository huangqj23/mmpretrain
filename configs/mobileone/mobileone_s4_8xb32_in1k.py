# Converted from configs/mobileone/mobileone-s4_8xb32_in1k.py by industrial-vision tools/convert_configs.py
from mmengine.config import read_base

with read_base():
    from .._base_.models.mobileone.mobileone_s4 import *  # noqa: F401,F403
