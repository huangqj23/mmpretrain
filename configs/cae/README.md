...
```shell
python tools/train.py configs/cae/cae_beit_base_p16_8xb256_amp_coslr_300e_in1k.py
```

Test:

```shell
python tools/test.py configs/cae/benchmarks/beit_base_p16_8xb128_coslr_100e_in1k.py https://download.openmmlab.com/mmselfsup/1.x/cae/cae_vit-base-p16_16xb128-fp16-coslr-300e_in1k/vit-base-p16_ft-8xb128-coslr-100e-rpe_in1k/vit-base-p16_ft-8xb128-coslr-100e-rpe_in1k_20220825-f3d234cd.pth
```
