# Converted from configs/_base_/models/twins_svt_base.py by industrial-vision tools/convert_configs.py
from mmengine.model import ConstantInit, TruncNormalInit
from torch.nn import LayerNorm

from mmpretrain.models import (SVT, CutMix, GlobalAveragePooling,
