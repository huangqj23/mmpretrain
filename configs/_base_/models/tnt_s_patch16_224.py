# Converted from configs/_base_/models/tnt_s_patch16_224.py by industrial-vision tools/convert_configs.py
from mmengine.model import ConstantInit, TruncNormalInit

from mmpretrain.models import (TNT, ImageClassifier, LabelSmoothLoss,
                               LinearClsHead)
