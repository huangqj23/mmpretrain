# Converted from configs/_base_/datasets/nlvr2.py by industrial-vision tools/convert_configs.py
from mmcv.transforms import LoadImageFromFile, RandomFlip, Resize
from mmengine.dataset import DefaultSampler

from mmpretrain.datasets import (NLVR2, ApplyToList, CleanCaption, PackInputs,
                                 RandomResizedCrop)
